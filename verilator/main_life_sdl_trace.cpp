...
int main(int argc, char *argv[])
{
    ...
    while (1)
    {
        ...
        if (top->sdl_sy < 0 || top->sdl_sx < 0 || top->sdl_sy > V_RES || top->sdl_sx > H_RES)
        {
            continue;
        }
        ...
        if (top->sdl_de)
        {
            ...
            // printf("rgb: (%d, %d, %d) at (%d, %d)\n", p->r, p->g, p->b, top->sdl_sx, top->sdl_sy);
        }
        ...
        // }
        if (top->sdl_sy == V_RES - 1 && top->sdl_sx == 0)
        {
